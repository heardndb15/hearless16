      ...
      <div className="container" style={{ maxWidth: 720 }}>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.text}>
            ...
            (пожарная сигнализация, дверной звонок, плач ребёнка), помогает изучать жестовый язык
            через камеру и даёт возможность отправить сигнал SOS в экстренной ситуации.
          </p>
        </section>
